...
export function createMockTriggerFunctions(): ITriggerFunctions {
  return {
    ...
    getNode: jest.fn().mockReturnValue({ id: 'test-node', name: 'Test Node', type: 'firestoreTrigger', typeVersion: 1, position: [0, 0], parameters: {} }),
    getWorkflow: jest.fn().mockReturnValue({ id: 'test-workflow', name: 'Test Workflow', active: true }),
